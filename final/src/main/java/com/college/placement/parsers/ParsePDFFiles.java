...
// JFileChooser points to user's default directory
        fileChooser = new JFileChooser("Attachments");
...
// Open the save dialog
    ...
    {
    	extensionRemoved = f.getName().split("\\.")[0];
    	System.out.println("Processing file..."+extensionRemoved);
    	words.clear();
    	try {
            ...
            /***
             * IMPORTANT INFORMATION NEEDED FROM PDF FILE
            ...
            //loops through all the words in words (ArrayList) and then gets relevant info based on words found (see switch statements)
            for (String word : words) {

                switch (word) {
                    //Not sure about this because this coul change and it means the following code for payments date will also have to change
                    case "www.hertzonlinepayments.com/gb/en":
                        index = words.indexOf(word);
                        valueAttribute = words.get(index + 1).toString().substring(19, 26);
//                        System.out.println();
//                        System.out.println("<------------------------>");
//                        System.out.print("Terms of Payment: ");
                        termsOfPayment = valueAttribute;
                        //System.out.println(idAttribute + " " + valueAttribute);
                        break;
                    case "HERTZ UK LTD":
                        index = words.indexOf(word);
                        valueAttribute = words.get(index).toString();
//                        System.out.println();
//                        System.out.println("<------------------------>");
//                        System.out.print("My Company Name: ");
                        myCompanyName = valueAttribute;
                        //.out.println(idAttribute + " " + valueAttribute);
                        break;
                    /*case "PLEASE PAY TO:":
                        index = words.indexOf(word);
                        valueAttribute = words.get(index + 6).toString() + ", " + words.get(index + 10).toString() + ", " + words.get(index + 12).toString().substring(0, 27) + ", " + words.get(index + 16).toString();
                        System.out.println();
                        System.out.println("<------------------------>");
                        System.out.print("My Company Address: ");
                        myCompanyAddress = valueAttribute;
                        System.out.println(idAttribute + " " + valueAttribute);
                        break;*/
                    case "Invoice Date:":
                        index = words.indexOf(word);
                        valueAttribute = words.get(index + 1).toString();
//                        System.out.println();
//                        System.out.println("<------------------------>");
//                        System.out.print("Invoice Date: ");
                        invoiceDate = valueAttribute;
                        //System.out.println(idAttribute + " " + valueAttribute);
                        break;
...
//                        System.out.print("Account No: ");
                        accountNumber = valueAttribute;
                        //System.out.println(idAttribute + " " + valueAttribute);
                        break;
                    case "Rental Agreement No:":
                        index = words.indexOf(word);
                        valueAttribute = words.get(index + 1).toString();
//                        System.out.println();
//                        System.out.println("<------------------------>");
//                        System.out.print("Rental Agreement No: ");
                        rentalAgreementNumber = Integer.parseInt(valueAttribute);
                        //System.out.println(idAttribute + " " + valueAttribute);
                        break;
                    case "Renting Company:":
                        index = words.indexOf(word);
                        valueAttribute = words.get(index + 4).toString();
//                        System.out.println();
//                        System.out.println("<------------------------>");
//                        System.out.print("Renting Company: ");
                        rentingCompany = valueAttribute;
                        customerCompanyName = valueAttribute;
                        //System.out.println(idAttribute + " " + valueAttribute);
                        break;
                    case "Reservation ID:":
                        index = words.indexOf(word);
...
//                        System.out.print("Invoice Amount: ");
                        invoiceSubTotalAmount = Double.parseDouble(valueAttribute);
                        //System.out.println(idAttribute + " " + valueAttribute);
                        break;
                    case "Please Pay:":
                        index = words.indexOf(word);
                        valueAttribute = words.get(index + 1).toString().substring(0, 6);
                        invoiceTotalPayAmount = valueAttribute;
                        break;
                }
            }
            ...
            accountNumber = "";
            rentalAgreementNumber = 0;
            reservationID = "";
            renter = "";
            invoiceSubTotalAmount = 0;
            invoiceTotalPayAmount = "";
            rentingCompany = "";
    ...
    public void writeAsExcelFile(File f, String sheetName)
    {
    	isSaved = false;
      ...
      Map<String, Object[]> studentData
  	  ...
  	  // save to file
      try {
          studentData.put("1", new Object[]{"Car Provider", "Customer Company", "Invoice Date", "Account No","Rental Agreement No", "Reservation ID","Renter","Car Description","Rented On", "Returned On", "Terms of Payment","Invoice Amount"});
          studentData.put("2", new Object[]{myCompanyName, customerCompanyName, invoiceDate, accountNumber,rentalAgreementNumber,reservationID,renter,carDescription,rentDate,returnDate,termsOfPayment,invoiceSubTotalAmount});
...
//          studentData.put("16", new Object[]{"Please Pay", invoiceTotalPayAmount});
          ...
          FileOutputStream out = new FileOutputStream(
                  new File("Exports/"+sheetName+".xlsx"));
    ...
    public boolean writeAsTextFile()
    {
    	boolean isSaved = false;
    	fileChooser = new JFileChooser("Exports");
...
//    }
     ...
     * Adds words read in from PDF into ArrayList
     */
    @Override
